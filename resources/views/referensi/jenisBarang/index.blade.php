...
@section('content')
                        ...
                        <tbody>
                            @foreach ($jenisBarang as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->jns_brg_nama }}</td>
                                    <td>
                                        <button class="btn btn-sm edit-btn btn-primary" data-id="{{ $item->jns_brg_kode }}"
                                            data-nama="{{ $item->jns_brg_nama }}" data-bs-toggle="modal"
                                            data-bs-target="#inlineForm">
                                            <i data-feather="edit"></i>
                                        </button>

                                        <form action="{{ route('jenis-barang.destroy', $item->jns_brg_kode) }}"
    ...
    @include('referensi.jenisBarang.modal')
@endsection
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.edit-btn').click(function() {
                ...
                $('.form-validate').attr('action', `/jenis-barang/${id}`);
                $('#formMethod').val('PUT');
            });
            ...
            $('#inlineForm').on('hidden.bs.modal', function() {
                ...
                $('#jquery-val-form').attr('action', "{{ route('jenis-barang.store') }}");
                $('#formMethod').val('POST');
            });
        });
