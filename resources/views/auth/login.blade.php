...
<body class="bg-gradient-primary">
    ...
    <div class="container flex">
        ...
        <!-- Outer Row -->
        <div class="row justify-content-center alighn-center justify-center">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('cek-login') }}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="user_nama"
                                                aria-describedby="emailHelp" placeholder="Enter User Nama..."
                                                name="user_nama">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="user_pass"
